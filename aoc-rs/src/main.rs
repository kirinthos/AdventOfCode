...
fn main() {
    ...
    let example_filename = format!(
        "../2023/problem.{:02}.example.{}",
        args.problem,
        if args.part2 { "2" } else { "1" }
    );
    let input_filename = format!("../2023/problem.{:02}.input", args.problem);
    ...
    let mut problem: Box<dyn Problem> = match problem_number {
        ...
        _ => unimplemented!("No solution yet!"), /*
                                                 ...
                                                 Problems::Problem20 => Box::new(problem20::Problem20 {}),
                                                 Problems::Problem21 => Box::new(problem21::Problem21 {}),
                                                 Problems::Problem22 => Box::new(problem22::Problem22 {}),
                                                 */
    };
